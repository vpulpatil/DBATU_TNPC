...
public class ListOfStudentTnpc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_of_student_tnpc);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                arrayAdapter = new ArrayAdapter(ListOfStudentTnpc.this, android.R.layout.simple_list_item_1, students);
                arrayAdapter.notifyDataSetChanged();
                studentList.smoothScrollToPosition(0);
                studentList.setAdapter(arrayAdapter);
                studentList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String rollno =(String) parent.getItemAtPosition(position);
                        Intent intent = new Intent(ListOfStudentTnpc.this, StudentInfoTnpc.class);
